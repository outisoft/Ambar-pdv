...
export default function Edit({ branch, companies }: Props) {
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-1">
                            Actualiza los detalles de la sucursal #{branch.id}.
                        </p>
                    </div>
                        ...
                        <div className="p-6">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">Información operativa.</p>
                                </div>
                            </div>
                        ...
                        <div className="p-6 bg-muted/20 flex justify-end gap-3">
                            ...
                            <Button type="submit" disabled={processing} className="bg-primary hover:bg-primary/90">
                                {processing ? 'Guardando...' : (
                                    <>
                                        <Save className="w-4 h-4 mr-2" /> Actualizar Sucursal
                                    </>
                                )}
                            </Button>
                        </div>

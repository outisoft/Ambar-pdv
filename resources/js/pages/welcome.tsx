                ...
                <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between p-4">
                        ...
                        {auth.user ? (
                            ...
                            <div className="flex gap-3">
                                ...
                                {canRegister && (
                                    <Link
                                        href={register()}
                                        className="text-white bg-[#FF750F] hover:bg-[#e0660d] focus:ring-4 focus:outline-none focus:ring-[#ff750f]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5"
                                    >
                                        Registrarse
                                    </Link>
                                )}
                    ...
                    <div className={`${isMobileMenuOpen ? 'block' : 'hidden'} items-center justify-between w-full md:flex md:w-auto md:order-1`}>
                        <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-[#161615] md:dark:bg-transparent dark:border-[#3E3E3A]">
                            ...
                            <li>
                                <a href="#caracteristicas" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#FF750F] md:p-0 dark:text-white md:dark:hover:text-[#FF750F] dark:hover:bg-[#2C2C2A] dark:hover:text-white md:dark:hover:bg-transparent transition-colors">Características</a>
                            </li>
                            <li>

...
<head>
    ...
    <title>502 | Puerta de enlace inválida</title>
    ...
    <div class="relative min-h-screen flex flex-col items-center justify-center px-4 overflow-hidden">
        ...
        <div class="max-w-xl w-full text-center">
            <div
                ...
                <span class="text-xs font-semibold tracking-wide text-slate-200 uppercase">Error 502</span>
            </div>
            ...
            <p class="text-base sm:text-lg text-slate-300 mb-8">
                El servidor actuando como puerta de enlace recibió una respuesta inválida.
                Puede ser un problema temporal de la infraestructura.
            </p>
                ...
                <div
                    ...
                    <div class="relative flex flex-col items-center gap-3">
                        <div
                            ...
                            <span class="text-2xl font-bold">502</span>
                        </div>
            ...
            <p class="mt-8 text-xs text-slate-400">
                Si el error persiste, avisa al equipo técnico para que revise los servicios externos.
            </p>
        </div>
    </div>
</body>

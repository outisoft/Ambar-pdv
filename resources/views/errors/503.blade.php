    ...
    <div class="relative min-h-screen flex flex-col items-center justify-center px-4 overflow-hidden">
        ...
        <div class="max-w-xl w-full text-center">
            <div
                ...
                <span class="text-xs font-semibold tracking-wide text-slate-200 uppercase">Error 503</span>
            </div>
            ...
            <p class="text-base sm:text-lg text-slate-300 mb-8">
                El sistema se encuentra en mantenimiento o experimenta una alta carga.
                Intenta acceder de nuevo en unos minutos.
            </p>
                ...
                <div
                    ...
                    <div class="relative flex flex-col items-center gap-3">
                        <div
                            ...
                            <span class="text-2xl font-bold">503</span>
                        </div>
            ...
            <p class="mt-8 text-xs text-slate-400">
                Si necesitas acceso urgente, comunícate con el equipo responsable de tu sistema de punto de venta.
            </p>
        </div>
    </div>
</body>

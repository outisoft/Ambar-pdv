...
<head>
    ...
    <title>505 | Versión HTTP no soportada</title>
    ...
    <div class="relative min-h-screen flex flex-col items-center justify-center px-4 overflow-hidden">
        ...
        <div class="max-w-xl w-full text-center">
            <div
                ...
                <span class="text-xs font-semibold tracking-wide text-slate-200 uppercase">Error 505</span>
            </div>
            ...
            <p class="text-base sm:text-lg text-slate-300 mb-8">
                El servidor no puede manejar la versión del protocolo HTTP utilizada en esta solicitud.
                Esto suele estar relacionado con la configuración de la infraestructura.
            </p>
                ...
                <div
                    ...
                    <div class="relative flex flex-col items-center gap-3">
                        <div
                            ...
                            <span class="text-2xl font-bold">505</span>
                        </div>
                        <p class="text-sm text-slate-300 max-w-xs">
                            Intenta nuevamente más tarde o informa al equipo técnico.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <p class="mt-8 text-xs text-slate-400">
                Si este error se repite, comparte esta pantalla con el equipo responsable de la infraestructura.
            </p>
        </div>
    </div>
</body>

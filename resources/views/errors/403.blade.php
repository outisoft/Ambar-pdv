    ...
    <div class="relative min-h-screen flex flex-col items-center justify-center px-4 overflow-hidden">
        ...
        <div class="max-w-xl w-full text-center">
            <div
                ...
                <span class="text-xs font-semibold tracking-wide text-slate-200 uppercase">Error 403</span>
            </div>
            ...
            <p class="text-base sm:text-lg text-slate-300 mb-8">
                No tienes permisos para visualizar esta página o realizar esta acción.
                Si crees que se trata de un error, ponte en contacto con el administrador
                de tu empresa o verifica tus credenciales.
            </p>
                ...
                <div
                    ...
                    <div class="relative flex flex-col items-center gap-3">
                        ...
                        <p class="text-sm text-slate-300 max-w-xs">
                            Tu rol actual no tiene acceso a este recurso dentro del punto de venta.
                        </p>
                    </div>
                </div>
            </div>
